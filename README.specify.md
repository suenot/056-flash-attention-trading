# Chapter 58: FlashAttention для Trading

## Описание

IO-aware exact attention algorithm для ускорения training и inference.
...
2. **FlashAttention-2: Faster Attention with Better Parallelism**
